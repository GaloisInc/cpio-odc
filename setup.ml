...
(* OASIS_START *)
(* DO NOT EDIT (digest: d4b0d81eca2b9b305d471dc8bf1f9a56) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Galois"; "Inc."];
          homepage = None;
          synopsis = "Simple reader for ODC format CPIO archives";
          description = None;
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "cpio-odc";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\206!\211\154\014Cg\012\160y\228\232\231\173\188Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
